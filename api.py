...
from document_extractor.controller import CardController, PDFController
from .pdf_ocr_service import diagnose_environment, OCRConfigurationError, OCRDependencyError

router = APIRouter(prefix="/document-extractor", tags=["Document Extractor"])
