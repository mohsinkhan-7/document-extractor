...
# === Load Image ===
img_path = "/Users/dell/PycharmProjects/PythonDataAnalytics-1/image-reader-cleanse/citizen-card/citizen-card-1-back.jpeg"
...
pil_img = ImageEnhance.Brightness(pil_img).enhance(5)
pil_img = ImageEnhance.Contrast(pil_img).enhance(6)
pil_img = ImageEnhance.Sharpness(pil_img).enhance(10)

# OCR (whole card)
ocr_text = pytesseract.image_to_string(pil_img, lang="eng")
print("[DEBUG] Full Card OCR Output:\n", ocr_text)
